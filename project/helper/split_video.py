...
def read_and_write_video_from_List(path_list: list, img_size: int = 256, video_save_path: str = ''):
    ...
    for path in path_list:
        ...
        video_Dict['video'] = video_frame
        video_Dict['label'] = 

        clip_pad_imgs = split.handle_batch_video(video_frame)  # c, t, h, w
    ...
    for f in FOLD:
        ...
        for key in final_video_path_Dict.keys():
            ...
            video_frame, now_video_path_list, video_info = read_and_write_video_from_List(
                now_video_path_list, img_size=IMG_SIZE, video_save_path=VIDEO_SAVE_PATH)
